...
class VisualMeasurementScreen extends StatefulWidget {
  const VisualMeasurementScreen({super.key});

  @override
  State<VisualMeasurementScreen> createState() => _VisualMeasurementScreenState();
}

class _VisualMeasurementScreenState extends State<VisualMeasurementScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: 20, 
            width: 1, 
            color: (hasValue ? Colors.green : Colors.black).withOpacity(0.3)
          ),
